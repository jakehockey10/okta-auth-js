...
Creates a new instance of the Okta Auth Client with the provided options. The client has many [config options](#user-content-client-configuration). The only required option to get started is `url`, the base url for your Okta domain.
